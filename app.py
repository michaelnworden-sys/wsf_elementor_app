...
def detect_intent_texts(text, session_id):
    # Set up the location and API endpoint
    location = "global"
    ...
    try:
        ...
        # Create the agent client with the credentials
        ...
        # Parse the response and pull out the text
        response_messages = [
        ...
        st.error("This could be due to an issue with your Dialogflow agent or the credentials secret.")
        return None
