...
def inject_custom_css():
    ...
    /* Makes the first column (map) sticky */
...
map_col, chat_col = st.columns([2, 3])

# Add the map to the first (left) column
with map_col:
    st.image(
...
# Add the entire chat interface to the second (right) column
with chat_col:
